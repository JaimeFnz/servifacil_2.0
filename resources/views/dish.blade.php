                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 text-dark">
                                ...
                                <p class="card-text"><strong>Alergias:</strong> {{ $dish->alergias ? $dish->alergias     : 'No tiene alergenos' }}</p>
                                <p class="card-text"><strong>Tipo:</strong> {{ ucfirst($dish->tipo) }}</p>
                            </div>
                            <div class="col-md-6 text-dark">
                                <p class="card-text"><strong>Comentarios:</strong> {{ $dish->comentarios ? $dish->comentarios : 'No hay comentarios.' }}</p>
                                <p class="card-text"><strong>Tiempo de preparación:</strong> {{ $dish->main }} minutos</p>
